...
1. [计算机基础书籍推荐](./计算机基础必读经典书籍.md)：先补操作系统、网络、数据结构与算法等通用基础。
2. [Java 书籍推荐](./java.md)：再系统学习 Java 基础、并发、JVM、框架和性能优化。
3. [数据库书籍推荐](./数据库必读经典书籍.md)：掌握 MySQL、Redis、NoSQL 和数据工程相关知识。
4. [分布式系统书籍推荐](./分布式必读经典书籍.md)：有项目经验后再深入分布式理论、架构和中间件。
5. [软件质量书籍推荐](./软件质量必读经典书籍.md)：用重构、测试、工程化和协作能力提升长期产出质量。

## 核心文章

- [计算机基础书籍推荐](./计算机基础必读经典书籍.md)：操作系统、计算机网络、数据结构与算法等基础书单，适合打底和面试复习。
- [Java 书籍推荐](./java.md)：覆盖 Java 基础、并发、JVM、框架、性能优化等方向的经典书籍。
- [数据库书籍推荐](./数据库必读经典书籍.md)：整理 MySQL、Redis、NoSQL、数据工程等后端常用数据库方向书籍。
- [分布式系统书籍推荐](./分布式必读经典书籍.md)：覆盖分布式理论、系统架构、中间件和工程实践。
- [搜索引擎书籍推荐](./搜索引擎必读经典书籍.md)：整理信息检索、搜索架构、Elasticsearch 等相关书籍与资料。
- [软件质量书籍推荐](./软件质量必读经典书籍.md)：覆盖代码质量、重构、测试、工程化和团队协作相关书籍。
