...
- [Java基础常见面试题总结(上)](./基础/Java基础常见面试题总结(上).md)：覆盖 Java 语言特点、基础语法、面向对象和常用类。
- [Java基础常见面试题总结(中)](./基础/Java基础常见面试题总结(中).md)：继续梳理异常、泛型、反射、注解和常见细节。
- [Java基础常见面试题总结(下)](./基础/Java基础常见面试题总结(下).md)：补齐高级基础知识和常见易错点。
- [Java 值传递详解](./基础/Java 值传递详解.md)：厘清值传递、引用变量和对象修改之间的关系。
- [Java 序列化详解](./基础/Java 序列化详解.md)：理解序列化机制、serialVersionUID、安全风险和替代方案。
- [Java 反射机制详解](./基础/Java 反射机制详解.md) 和 [Java 代理模式详解](./基础/Java 代理模式详解.md)：掌握框架底层常见机制。

### Java 集合

- [Java 集合专题](./集合/)：串联集合框架、使用注意事项和常见源码分析。
- [Java集合常见面试题总结(上)](./集合/Java集合常见面试题总结(上).md) 和 [Java集合常见面试题总结(下)](./集合/Java集合常见面试题总结(下).md)：覆盖 List、Set、Map、Queue 和并发集合高频问题。
- [Java集合使用注意事项总结](./集合/Java集合使用注意事项总结.md)：总结集合判空、遍历、扩容、线程安全和性能相关注意点。
- [ArrayList 源码分析](./集合/ArrayList 源码分析.md)、[HashMap 源码分析](./集合/HashMap 源码分析.md)、[ConcurrentHashMap 源码分析](./集合/ConcurrentHashMap 源码分析.md)：从源码理解常用容器的设计取舍。

### Java 并发

- [Java 并发编程专题](./并发/)：围绕线程、锁、内存模型、线程池和并发工具展开。
- [Java并发常见面试题总结（上）](./并发/Java并发常见面试题总结（上）.md)、[Java并发常见面试题总结（中）](./并发/Java并发常见面试题总结（中）.md)、[Java并发常见面试题总结（下）](./并发/Java并发常见面试题总结（下）.md)：建立并发面试问题清单。
- [JMM（Java 内存模型）详解](./并发/JMM（Java 内存模型）详解.md)：理解可见性、原子性、有序性和 happens-before。
- [CAS 详解](./并发/CAS 详解.md)、[AQS 详解](./并发/AQS 详解.md)、[Java 线程池详解](./并发/Java 线程池详解.md)：掌握并发底层高频考点。
- [虚拟线程常见问题总结](./并发/虚拟线程常见问题总结.md)：理解 Project Loom 对并发模型的影响。

### JVM 与 IO

- [JVM 专题](./jvm/)：围绕内存、类加载、GC、参数、工具和线上排查展开。
- [Java内存区域详解（重点）](./jvm/Java内存区域详解（重点）.md)：理解程序计数器、虚拟机栈、本地方法栈、堆和方法区。
- [JVM垃圾回收详解（重点）](./jvm/JVM垃圾回收详解（重点）_2.md)：理解对象存活判断、垃圾收集算法和主流垃圾收集器。
- [类加载过程详解](./jvm/类加载过程详解_2.md) 和 [类加载器详解（重点）](./jvm/类加载器详解（重点）_2.md)：掌握类生命周期和双亲委派模型。
- [Java IO 专题](./io/)：从 BIO、NIO、AIO 讲到 IO 模型和 IO 设计模式。
- [Java IO 基础知识总结](./io/Java IO 基础知识总结_2.md)、[Java NIO 核心知识总结](./io/Java NIO 核心知识总结_2.md)、[Java IO 模型详解](./io/Java IO 模型详解_2.md)：补齐网络编程和中间件学习前置知识。

### Java 新特性

- [Java 新特性专题](./新特性/)：按版本梳理 Java 8 之后的重要语言、标准库和 JVM 特性。
- [Java8 新特性实战](./新特性/Java8 新特性实战.md)：掌握 Lambda、Stream、Optional、接口默认方法和新日期 API。
- [Java 11 新特性概览（重要）](./新特性/Java 11 新特性概览（重要）.md)、[Java 17 新特性概览（重要）](./新特性/Java 17 新特性概览（重要）.md)、[Java 21 新特性概览(重要)](./新特性/Java 21 新特性概览(重要).md)：优先关注 LTS 版本中的长期可用特性。
