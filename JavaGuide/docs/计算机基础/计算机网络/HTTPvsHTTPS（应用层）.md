...
![](./图片/HTTP与HTTPS/public-key-cryptography.png)
...
![](./图片/HTTP与HTTPS/symmetric-encryption.png)
...
![](./图片/HTTP与HTTPS/digital-signature.png)
...
![](./图片/HTTP与HTTPS/public-key-transmission.png)
