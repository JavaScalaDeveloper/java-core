...
<!-- source: HTTP 1.0 vs HTTP 1.1-长连接、缓存、Host 头等核心差异（应用层）.md -->

## [4] HTTP 1.0 vs HTTP 1.1：长连接、缓存、Host 头等核心差异（应用层）
...
<!-- source: HTTP vs HTTPS-区别在哪里、HTTPS 为什么更安全（应用层）.md -->

## [5] HTTP vs HTTPS：区别在哪里、HTTPS 为什么更安全（应用层）
...
<!-- source: HTTPS 握手里的 RSA 和 ECDHE，到底差在哪？（应用层）.md -->

## [7] HTTPS 握手里的 RSA 和 ECDHE，到底差在哪？（应用层）
...
<!-- source: OSI 七层模型与 TCPIP 四层模型详解.md -->

## [9] OSI 七层模型与 TCP/IP 四层模型详解
...
<!-- source: TCP Keepalive 和 HTTP Keep-Alive 有什么区别？.md -->

## [10] TCP Keepalive 和 HTTP Keep-Alive 有什么区别？
...
<!-- source: TCP TIMEWAIT 详解-为什么要等、会不会出问题、能不能复用？.md -->

## [11] TCP TIME_WAIT 详解：为什么要等、会不会出问题、能不能复用？
...
<!-- source: TCP 和 UDP 可以使用同一个端口吗？.md -->

## [12] TCP 和 UDP 可以使用同一个端口吗？
...
<!-- source: TCP 如何保证可靠传输？重传、滑动窗口与拥塞控制详解.md -->

## [13] TCP 如何保证可靠传输？重传、滑动窗口与拥塞控制详解
...
<!-- source: TCP 三次握手和四次挥手（传输层）.md -->

## [14] TCP 三次握手和四次挥手（传输层）
...
<!-- source: 常见应用层协议总结-HTTP、WebSocket、SMTP、FTP、SSH、DNS 等.md -->

## [15] 常见应用层协议总结：HTTP、WebSocket、SMTP、FTP、SSH、DNS 等
...
<!-- source: 从输入 URL 到页面展示到底发生了什么？.md -->

## [16] 从输入 URL 到页面展示到底发生了什么？
...
<!-- source: 能 Ping 通，TCP 就一定能连通吗？.md -->

## [19] 能 Ping 通，TCP 就一定能连通吗？
...
<!-- source: 为什么 TCP 是面向字节流，UDP 是面向报文？（传输层）.md -->

## [21] 为什么 TCP 是面向字节流，UDP 是面向报文？（传输层）
...
<!-- source: 一台主机上只能保持最多 65535 个 TCP 连接吗？.md -->

## [22] 一台主机上只能保持最多 65535 个 TCP 连接吗？
...
<!-- source: 有了 HTTP 协议，为什么还要 RPC？HTTP 与 RPC 区别对比.md -->

## [23] 有了 HTTP 协议，为什么还要 RPC？HTTP 与 RPC 区别对比
