...
1. [时间复杂度和空间复杂度面试指南](./时间复杂度和空间复杂度面试指南-Big O、递归复杂度与常见误区.md)：先把 Big O、递归复杂度和常见误判讲清楚。
2. [二分查找面试题总结](./二分查找面试题总结-左右边界、答案二分与 Java 模板.md)：练基础二分、左右边界和答案二分。
3. [双指针与滑动窗口面试题总结](./双指针与滑动窗口面试题总结-数组、链表、字符串高频模板.md)：解决数组、字符串、链表里的高频题。
4. [DFS 与 BFS 面试题总结](./DFS 与 BFS 面试题总结-树、图、矩阵搜索与最短路径模板.md)：掌握树、图、矩阵搜索和层序遍历。
5. [回溯算法面试题总结](./回溯算法面试题总结-组合、排列、子集、剪枝与 Java 模板.md)：集中处理组合、排列、子集和棋盘问题。
6. [动态规划面试题总结](./动态规划面试题总结-状态转移、背包、子序列与 Java 模板.md)：从状态定义和转移方程入手，不靠背题。
7. [贪心算法面试题总结](./贪心算法面试题总结-区间贪心、跳跃游戏与证明思路.md) 和 [Top K 问题面试题总结](./Top K 问题面试题总结-堆、快排分区、桶计数与数据流.md)：补齐排序贪心、堆、快排分区和桶计数。
8. [几道常见的字符串算法题](./几道常见的字符串算法题.md)、[几道常见的链表算法题](./几道常见的链表算法题.md)、[十大经典排序算法总结](./十大经典排序算法总结.md)：按专题做面试前复盘。

## 核心模板

| 模板     | 识别信号                                   | 重点文章                                                           |
| -------- | ------------------------------------------ | ------------------------------------------------------------------ |
| 二分查找 | 有序、单调、最小可行值、最大可行值         | [二分查找面试题总结](./二分查找面试题总结-左右边界、答案二分与 Java 模板.md)                           |
| 双指针   | 原地修改、两端收缩、快慢追赶、链表定位     | [双指针与滑动窗口面试题总结](./双指针与滑动窗口面试题总结-数组、链表、字符串高频模板.md) |
| 滑动窗口 | 连续子数组、连续子串、最长/最短窗口        | [双指针与滑动窗口面试题总结](./双指针与滑动窗口面试题总结-数组、链表、字符串高频模板.md) |
| DFS/BFS  | 树遍历、图遍历、矩阵连通块、层序最短步数   | [DFS 与 BFS 面试题总结](./DFS 与 BFS 面试题总结-树、图、矩阵搜索与最短路径模板.md)                              |
| 回溯     | 枚举所有方案、路径选择、组合排列、棋盘约束 | [回溯算法面试题总结](./回溯算法面试题总结-组合、排列、子集、剪枝与 Java 模板.md)                            |
| 动态规划 | 最优值、计数、能否到达、子序列、背包       | [动态规划面试题总结](./动态规划面试题总结-状态转移、背包、子序列与 Java 模板.md)                     |
| 贪心     | 每一步选择当前最合适的对象，常和排序搭配   | [贪心算法面试题总结](./贪心算法面试题总结-区间贪心、跳跃游戏与证明思路.md)                                  |
| Top K    | 第 K 大、前 K 高频、数据流、优先级         | [Top K 问题面试题总结](./Top K 问题面试题总结-堆、快排分区、桶计数与数据流.md)                                 |
...
- [计算机基础知识体系](../)
- [数据结构专题](../数据结构/)
- [常见数据结构经典 LeetCode 题目推荐](./常见数据结构经典 LeetCode 题目推荐.md)
- [经典算法思想总结](./经典算法思想总结（含 LeetCode 题目推荐）.md)
