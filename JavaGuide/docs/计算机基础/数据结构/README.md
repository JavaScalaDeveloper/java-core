...
1. [线性数据结构详解](./线性数据结构详解（数组、链表、栈、队列）.md)：先掌握数组、链表、栈、队列，理解顺序存储和链式存储。
2. [哈希表面试题总结](./哈希表面试题总结-哈希冲突、扩容与 Java HashMap.md)：理解哈希函数、冲突、扩容，并和 `HashMap` 连起来。
3. [树结构详解](./树结构详解（二叉树、AVL、BB+树）.md)：掌握二叉树、二叉搜索树、AVL、B 树、B+ 树，以及 MySQL 索引关联。
4. [堆详解](./堆详解（最大堆、最小堆、优先队列）.md)：理解优先队列、Top K、堆排序和 `PriorityQueue`。
5. [图详解](./图详解（DFS、BFS、最短路径）.md)：理解图的存储、DFS、BFS、拓扑排序和最短路径入口。
6. [Trie 前缀树面试题总结](./Trie 前缀树面试题总结-字典树原理、前缀匹配与 Java 实现.md)、[并查集面试题总结](./并查集面试题总结-路径压缩、连通性与 Java 模板.md)：补齐字符串集合和连通性问题。
7. [跳表面试题总结](./跳表面试题总结-多级索引、范围查询与 Redis ZSet.md)、[红黑树详解](./红黑树详解（性质、旋转、应用）.md)、[布隆过滤器详解](./布隆过滤器详解（原理、实现、应用场景）.md)、[LRU 缓存面试题总结](./LRU 缓存面试题总结-哈希表、双向链表与 LinkedHashMap.md)：面向 Java 集合、Redis、缓存和数据库场景复盘。

## 核心文章

| 文章                                           | 重点                          | 常见关联                            |
| ---------------------------------------------- | ----------------------------- | ----------------------------------- |
| [线性数据结构详解](./线性数据结构详解（数组、链表、栈、队列）.md) | 数组、链表、栈、队列          | `ArrayList`、`LinkedList`、消息队列 |
| [哈希表面试题总结](./哈希表面试题总结-哈希冲突、扩容与 Java HashMap.md)            | 哈希函数、冲突、扩容          | `HashMap`、缓存、去重               |
| [树结构详解](./树结构详解（二叉树、AVL、BB+树）.md)                        | 二叉树、BST、AVL、B 树、B+ 树 | MySQL 索引、表达式树                |
| [图详解](./图详解（DFS、BFS、最短路径）.md)                           | 邻接表、邻接矩阵、DFS、BFS    | 依赖关系、路由、推荐关系            |
| [堆详解](./堆详解（最大堆、最小堆、优先队列）.md)                            | 最大堆、最小堆、堆排序        | `PriorityQueue`、Top K、延迟队列    |
| [红黑树详解](./红黑树详解（性质、旋转、应用）.md)              | 近似平衡、旋转、变色          | `TreeMap`、`HashMap` 树化           |
| [布隆过滤器详解](./布隆过滤器详解（原理、实现、应用场景）.md)            | 位数组、哈希、误判            | 缓存穿透、去重、黑名单              |
| [跳表面试题总结](./跳表面试题总结-多级索引、范围查询与 Redis ZSet.md)               | 多级索引、范围查询            | Redis ZSet                          |
| [LRU 缓存面试题总结](./LRU 缓存面试题总结-哈希表、双向链表与 LinkedHashMap.md)           | 哈希表 + 双向链表             | 本地缓存、页面置换                  |
...
- [计算机基础知识体系](../)
- [算法专题](../算法/)
- [常见数据结构经典 LeetCode 题目推荐](../算法/常见数据结构经典 LeetCode 题目推荐.md)
- [Java 集合](../../java/集合/Java集合常见面试题总结(上).md)
- [MySQL 索引详解](../../数据库/mysql/MySQL索引详解.md)
- [Redis 常见面试题总结](../../数据库/redis/Redis常见面试题总结(上).md)
- [面试准备](../../面试准备/)
