...
- [Java 后端学习路线（2026 最新版）](./Java 后端学习路线（2026 最新版）.md)：从 Java 基础、集合、并发、JVM、Spring、数据库、分布式到项目实践，适合 Java 后端系统学习和求职准备。
...
- [后端开发者转型 AI Agent 学习建议（2026 最新版）](./后端开发者转型 AI Agent 学习建议（2026 最新版）.md)：先判断是否适合转型，再看 Java AI 与 Python AI 怎么选、能投什么岗位、应该如何学习。

## 全栈方向

- [后端开发者全栈学习路线（2026 最新版）](./后端开发者全栈学习路线（2026 最新版）-AI 时代如何补齐前端和交付能力.md)：结合 AI 编程工具，讲清后端开发者如何补齐前端能力，逐步具备独立交付完整功能的能力。

## 测试开发方向

- [测试开发学习路线（2026 最新版）](./测试开发学习路线（2026 最新版）-AI 时代如何从测试走向质量工程.md)：面向测开、自动化测试和质量工程方向，覆盖测试理论、接口/UI/性能自动化、CI/CD、测试平台、AI 辅助测试和 AI 应用评测。
