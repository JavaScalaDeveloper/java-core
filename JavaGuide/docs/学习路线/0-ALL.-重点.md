...
## [2] Java/Go 开发者 AI 应用开发与 Agent 学习路线（2026 最新版）
...
## [3] 测试开发学习路线（2026 最新版）：AI 时代如何从测试走向质量工程
...
- [Java 单元测试](../系统设计/基础/单元测试到底是什么？应该怎么做？.md)
...
## [4] 后端开发者全栈学习路线（2026 最新版）：AI 时代如何补齐前端和交付能力
...
## [5] 后端开发者转型 AI Agent 学习建议（2026 最新版）
