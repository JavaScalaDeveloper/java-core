...
1. [Git 核心概念总结](./git/Git 核心概念总结.md)：先掌握版本控制、提交、分支、合并和协作流程。
2. [Maven 核心概念总结](./maven/Maven 核心概念总结.md)：理解 Java 项目构建、POM、坐标、仓库、依赖和生命周期。
3. [Maven 最佳实践](./maven/Maven 最佳实践.md)：补齐依赖版本管理、BOM、Maven Wrapper、CI 和日常使用规范。
4. [Docker 核心概念总结](./docker/Docker 核心概念总结.md)：建立镜像、容器、仓库和 Docker 引擎的基本认知。
5. [Docker 实战](./docker/Docker 实战.md)：通过命令和场景练习容器管理、镜像构建、数据卷和常见排查。
6. [Gradle 核心概念总结](./gradle/Gradle 核心概念总结.md) 和 [GitHub 实用小技巧总结](./git/GitHub 实用小技巧总结.md)：按项目需要补充 Gradle Wrapper、GitHub Actions 与代码阅读技巧。
...
- [Maven 核心概念总结](./maven/Maven 核心概念总结.md)：理解 POM、坐标、仓库、依赖范围、生命周期、插件和多模块项目。
- [Maven 最佳实践](./maven/Maven 最佳实践.md)：整理标准目录结构、编译版本、依赖管理、Maven Wrapper、CI 和常用实践建议。
- [Gradle 核心概念总结](./gradle/Gradle 核心概念总结.md)：了解 Gradle、Groovy/Kotlin DSL、Gradle Wrapper、插件和 Task 等核心概念。

### 版本控制与代码协作

- [Git 专题](./git/)：围绕 Git 核心概念、工作流和 GitHub 提效技巧展开。
- [Git 核心概念总结](./git/Git 核心概念总结.md)：理解版本控制、工作区、暂存区、提交、分支、合并、冲突和远程仓库。
- [GitHub 实用小技巧总结](./git/GitHub 实用小技巧总结.md)：整理个人主页、项目徽章、代码阅读、Actions、Explore/Trending 和开源协作相关技巧。

### 容器化与本地环境

- [Docker 专题](./docker/)：从核心概念到实战操作，帮助理解容器化交付和环境一致性。
- [Docker 核心概念总结](./docker/Docker 核心概念总结.md)：理解容器、镜像、仓库、Docker 引擎以及容器和虚拟机的区别。
- [Docker 实战](./docker/Docker 实战.md)：通过镜像、容器、网络、数据卷、日志和排查命令完成 Docker 入门实践。
