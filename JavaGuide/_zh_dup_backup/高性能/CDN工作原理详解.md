...
**CDN** 全称是 Content Delivery Net工作/Content Distribution Network，翻译过的意思是 **内容分发网络** 。
...
![京东仓配系统](https://oss.javaguide.cn/github/javaguide/高性能/cdn/jingdong-wuliu-cangpei.png)

你可以将 CDN 看作是服务上一层的**特殊缓存服务**，分布在全国各地，主要用来处理静态资源的请求。

![CDN 简易示意图](https://oss.javaguide.cn/github/javaguide/高性能/cdn/cdn-101.png)

我们经常拿全站加速和内容分发网络做对比，不要把两者搞混了！**全站加速**（不同云服务商叫法不同，腾讯云叫 ECDN、阿里云叫 DCDN）既可以加速静态资源又可以加速动态资源，而**内容分发网络（CDN）** 主要针对的是 **静态资源** 。

![阿里云文档：https://help.aliyun.com/document_detail/64836.html](https://oss.javaguide.cn/github/javaguide/高性能/cdn/cdn-aliyun-dcdn.png)
...
![CDN 缓存的完整生命周期](https://oss.javaguide.cn/github/javaguide/高性能/cdn/cdn-full-life-cycle-of-cdn-cache.png)

如果资源有更新，可以对其进行**刷新**操作，删除 CDN 节点上缓存的旧资源，并强制 CDN 节点在下次请求时回源获取最新资源。

几乎所有云厂商提供的 CDN 服务都具备缓存的刷新和预热功能（下图是阿里云 CDN 服务提供的相应功能）：

![CDN 缓存的刷新和预热](https://oss.javaguide.cn/github/javaguide/高性能/cdn/cdn-refresh-warm-up.png)
...
![腾讯云 CDN Referer 防盗链配置](https://oss.javaguide.cn/github/javaguide/高性能/cdn/cnd-tencent-cloud-anti-theft.png)
...
![](https://oss.javaguide.cn/github/javaguide/高性能/cdn/timestamp-anti-theft.png)

绝大部分 CDN 服务提供商都支持开箱即用的时间戳防盗链机制：

![七牛云时间戳防盗链配置](https://oss.javaguide.cn/github/javaguide/高性能/cdn/qiniuyun-timestamp-anti-theft.png)
