...
![FTP工作过程](https://oss.javaguide.cn/github/javaguide/计算机基础/计算机网络/ftp.png)
...
![Telnet:远程登陆协议](https://oss.javaguide.cn/github/javaguide/计算机基础/计算机网络/Telnet_is_vulnerable_to_eavesdropping-2.png)
