...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/工具/tabby-01.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/工具/tabby-02.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/工具/tabby-03.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/工具/tabby-04.png)

填写服务器的 IP 地址和密码，然后点击「save」。


![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/工具/tabby-05.png)

之后点击「运行」按钮，就可以进入到终端页面了。


![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/工具/tabby-06.png)


好了，现在可以对服务器进行操作了，执行下 top 命令可以查看服务器上正在运行的进程信息。


![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/工具/tabby-07.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/工具/tabby-08.png)

上传的时候支持拖拽，完成后会弹出文件传输成功的提示消息。


![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/工具/tabby-09.png)

下载的时候点击要下载的文件，然后会弹出存储对话框，选择对应的文件夹，以及修改对应的文件名点击「存储」就可以了。


![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/工具/tabby-10.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/工具/tabby-11.png)

「Appearance」的菜单可以对 Tabby 的配色方案进行修改，里面的主题非常多，不过我感觉默认的就挺不错，毕竟是官方推荐的。



![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/工具/tabby-12.png)

 「Plugins」 菜单中还有不少插件可供扩展。


![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/工具/tabby-13.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/工具/tabby-14.png)

生效后点击「Sync Config」菜单，就可以看到配置项了，类型可以选择 GitHub、Gitee、GitLab。


![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/工具/tabby-15.png)

这里以 Gitee 为例，进入个人 Gitee 主页，左侧菜单中选择「私人令牌」，然后点击「生成新令牌」。


![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/工具/tabby-16.png)

提交后会生成 token，复制到 Tabby 的 Token 输入框中，然后点击「Upload config」，就可以看到配置信息同步成功了。


![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/工具/tabby-17.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/工具/tabby-18.png)
