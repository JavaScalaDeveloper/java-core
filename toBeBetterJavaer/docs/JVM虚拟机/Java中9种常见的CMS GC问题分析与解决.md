...
如上图所示，我们很清晰的就能知道是什么原因引起的 GC，以及每次的时间花费情况，但是要分析 GC 的问题，先要读懂 GC Cause，即 JVM 什么样的条件下选择进行 GC 操作，具体 Cause 的分类可以看一下 Hotspot 源码：src/share/vm/咱们从头到尾说一次Java垃圾回收/shared/gcCause.hpp 和 src/share/vm/咱们从头到尾说一次Java垃圾回收/shared/gcCause.cpp 中。
...
什么时机使用这些 Cause 触发回收，大家可以看一下 CMS 的代码，这里就不讨论了，具体在 /src/hotspot/share/咱们从头到尾说一次Java垃圾回收/cms/concurrentMarkSweepGeneration.cpp 中。
...
具体动态计算可以看一下 Hotspot 源码，具体在 /src/hotspot/share/咱们从头到尾说一次Java垃圾回收/shared/ageTable.cpp 的 `compute_tenuring_threshold` 方法中：
...
具体代码在：src/hotspot/share/咱们从头到尾说一次Java垃圾回收/cms/concurrentMarkSweepThread.cpp。
...
判断是否进行回收的代码在：/src/hotspot/share/咱们从头到尾说一次Java垃圾回收/cms/concurrentMarkSweepGeneration.cpp。
