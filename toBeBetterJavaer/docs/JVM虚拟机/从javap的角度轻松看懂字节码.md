...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/面渣逆袭（Java 虚拟机-JVM面试题八股文）必看👍/bytecode-dd31bbd6-c75c-4426-9437-c0f57ea3b86f.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/面渣逆袭（Java 虚拟机-JVM面试题八股文）必看👍/bytecode-bd941085-ff0e-4abf-a5f9-afb0493bfed7.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/面渣逆袭（Java 虚拟机-JVM面试题八股文）必看👍/bytecode-84b7af5c-93b1-4f63-bb30-946ab3d7e98c.png)


OK，我们输入命令 `javap -v -p Main.class` 来查看一下输出的内容。

```
Classfile /Users/maweiqing/Documents/GitHub/TechSisterLearnJava/codes/TechSister/target/classes/com/itwanger/面渣逆袭（Java 虚拟机-JVM面试题八股文）必看👍/Main.class
...
public class com.itwanger.jvm.Main
  ...
  this_class: #3                          // com/itwanger/面渣逆袭（Java 虚拟机-JVM面试题八股文）必看👍/Main
  super_class: #4                         // java/lang/Object
  interfaces: 0, fields: 1, methods: 2, attributes: 1
Constant pool:
   #1 = Methodref          #4.#18         // java/lang/Object."<init>":()V
   #2 = Fieldref           #3.#19         // com/itwanger/面渣逆袭（Java 虚拟机-JVM面试题八股文）必看👍/Main.age:I
   #3 = Class              #20            // com/itwanger/面渣逆袭（Java 虚拟机-JVM面试题八股文）必看👍/Main
  ...
  #12 = Utf8               this
  #13 = Utf8               Lcom/itwanger/面渣逆袭（Java 虚拟机-JVM面试题八股文）必看👍/Main;
  #14 = Utf8               getAge
  #15 = Utf8               ()I
  #16 = Utf8               SourceFile
  #17 = Utf8               Main.java
  ...
  #20 = Utf8               com/itwanger/面渣逆袭（Java 虚拟机-JVM面试题八股文）必看👍/Main
  #21 = Utf8               java/lang/Object
{
    ...
    Code:
      ...
      LocalVariableTable:
        Start  Length  Slot  Name   Signature
            0      11     0  this   Lcom/itwanger/面渣逆袭（Java 虚拟机-JVM面试题八股文）必看👍/Main;
  ...
  public int getAge();
    ...
    Code:
      ...
      LocalVariableTable:
        Start  Length  Slot  Name   Signature
            0       5     0  this   Lcom/itwanger/面渣逆袭（Java 虚拟机-JVM面试题八股文）必看👍/Main;
}
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/面渣逆袭（Java 虚拟机-JVM面试题八股文）必看👍/bytecode-d12d6983-f427-40d2-bb4b-3a2c6c4c7806.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/面渣逆袭（Java 虚拟机-JVM面试题八股文）必看👍/bytecode-cbf16ce9-7853-4050-a1c0-8b874f3b0c1e.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/面渣逆袭（Java 虚拟机-JVM面试题八股文）必看👍/bytecode-5f328e11-3486-4eb4-8fa9-5c5febfab894.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/面渣逆袭（Java 虚拟机-JVM面试题八股文）必看👍/bytecode-fd434d5c-ffc6-4a24-9787-98e573035068.png)
