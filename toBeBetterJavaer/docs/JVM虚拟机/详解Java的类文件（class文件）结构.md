...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/面渣逆袭（Java 虚拟机-JVM面试题八股文）必看👍/class-file-jiegou-dfd7ce0d-1da2-4547-b2d7-57e0350f5911.png)

Java 是跨平台的，JVM 作为中间层，自然要针对不同的操作系统提供不同的实现。拿 JDK 11 来说，它的实现就有上图中提到的这么多种。


![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/面渣逆袭（Java 虚拟机-JVM面试题八股文）必看👍/class-file-jiegou-b1386f9e-c69b-44b0-a8d0-69ffbe9ed31f.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/面渣逆袭（Java 虚拟机-JVM面试题八股文）必看👍/class-file-jiegou-cb4afe63-6a8e-4ae1-a822-d4163c814daa.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/面渣逆袭（Java 虚拟机-JVM面试题八股文）必看👍/class-file-jiegou-bbe4c673-c3a5-4952-901d-35446f91a3af.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/面渣逆袭（Java 虚拟机-JVM面试题八股文）必看👍/class-file-jiegou-2c876f52-1cc1-4076-807a-d85a1cb80e75.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/面渣逆袭（Java 虚拟机-JVM面试题八股文）必看👍/class-file-jiegou-801ed589-658c-407e-ac64-81fd525d7324.png)

前面还有 3 个字节，第一个字节 0x01 是标识，标识类型为 *CONSTANT_Uft8_info*，第二个和第三个自己 0x00 0x05 用来表示第三部分字节数组的长度。


![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/面渣逆袭（Java 虚拟机-JVM面试题八股文）必看👍/class-file-jiegou-ae4f38c9-68fe-40ad-91c6-3e7fd360de05.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/面渣逆袭（Java 虚拟机-JVM面试题八股文）必看👍/class-file-jiegou-4e093bef-d592-4be7-847e-0ef5900c5fa4.png)

*CONSTANT_String_info* 通过索引 19 来找到 *CONSTANT_Uft8_info*。


![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/面渣逆袭（Java 虚拟机-JVM面试题八股文）必看👍/class-file-jiegou-85af064d-5dc6-4187-b4f3-3501ccfc99b3.png)
...
拿 Hello.java 类来说，它的全路径限定名为 `com/itwanger/面渣逆袭（Java 虚拟机-JVM面试题八股文）必看👍/Hello`，对应的十六进制为“636f6d2f697477616e6765722f6a766d2f48656c6c6f”，是一串 *CONSTANT_Uft8_info*，指向它的 *CONSTANT_Class_info* 在 class 文件中的什么位置呢？
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/面渣逆袭（Java 虚拟机-JVM面试题八股文）必看👍/class-file-jiegou-ac6cc8cf-ed25-4bbb-8685-d473ecf15a60.png)

从上图中可以看到，常量池的总大小为 23，索引为 04 的 *CONSTANT_Class_info* 指向的是是索引为 21 的 *CONSTANT_Uft8_info*，值为 `com/itwanger/面渣逆袭（Java 虚拟机-JVM面试题八股文）必看👍/Hello`。21 的十六进制为 0x15，有了这个信息，我们就可以找到 *CONSTANT_Class_info* 在 class 文件中的位置了。


![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/面渣逆袭（Java 虚拟机-JVM面试题八股文）必看👍/class-file-jiegou-74816960-b8f7-42f3-9001-c05ebd25f58d.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/面渣逆袭（Java 虚拟机-JVM面试题八股文）必看👍/class-file-jiegou-70cd8902-136c-42a4-ab57-d6baf202e462.png)

一个是 4，一个是 5，可以通过下图来表示 *CONSTANT_NameAndType_info* 的构成。


![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/面渣逆袭（Java 虚拟机-JVM面试题八股文）必看👍/class-file-jiegou-5ac7d4c4-b905-462c-90f7-58b46fc5dda1.png)

对应 class 文件中的位置如下图所示。


![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/面渣逆袭（Java 虚拟机-JVM面试题八股文）必看👍/class-file-jiegou-eba9e047-d6fb-43e7-8c27-3683a076ccdd.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/面渣逆袭（Java 虚拟机-JVM面试题八股文）必看👍/class-file-jiegou-1f5d3154-9a28-4cfa-935e-43d7e023036e.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/面渣逆袭（Java 虚拟机-JVM面试题八股文）必看👍/class-file-jiegou-d4873db5-1a9d-4e05-9765-59a71b083fe5.png)

对应 class 文件中的位置如下图所示。


![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/面渣逆袭（Java 虚拟机-JVM面试题八股文）必看👍/class-file-jiegou-774e8289-582b-4762-9dce-b0590ee5ad3f.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/面渣逆袭（Java 虚拟机-JVM面试题八股文）必看👍/class-file-jiegou-77c4ecff-6d36-405d-93da-ee06431bf312.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/面渣逆袭（Java 虚拟机-JVM面试题八股文）必看👍/class-file-jiegou-6d5d9189-12a2-45d3-b811-92deede2f78d.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/面渣逆袭（Java 虚拟机-JVM面试题八股文）必看👍/class-file-jiegou-5a40ed62-4ff2-4101-b2d5-15760032f563.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/面渣逆袭（Java 虚拟机-JVM面试题八股文）必看👍/class-file-jiegou-cbe6d025-84a5-4fea-821b-a4234f47c6cd.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/面渣逆袭（Java 虚拟机-JVM面试题八股文）必看👍/class-file-jiegou-f3932093-46f3-4ef0-8598-bbd70515a9bd.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/面渣逆袭（Java 虚拟机-JVM面试题八股文）必看👍/class-file-jiegou-dee995d6-e285-4a31-b11f-e93c3599cd8e.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/面渣逆袭（Java 虚拟机-JVM面试题八股文）必看👍/class-file-jiegou-53f73e24-f060-45d2-8e29-34263c31847b.png)

对应到 class 文件中的位置如下图所示。


![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/面渣逆袭（Java 虚拟机-JVM面试题八股文）必看👍/class-file-jiegou-423341a7-3aeb-4ac9-95e8-a1e7f7847255.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/面渣逆袭（Java 虚拟机-JVM面试题八股文）必看👍/class-file-jiegou-e76339a8-0aab-418b-9722-4b3c8591693c.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/面渣逆袭（Java 虚拟机-JVM面试题八股文）必看👍/class-file-jiegou-b5853549-b17b-48eb-8eb3-a393fb5d655f.png)
