...
9.  [Java多线程（十）之ReentrantReadWriteLock深入分析](https://my.oschina.net/adan1/博客/158107)
10.  [Java–读写锁的实现原理](https://mrdear.cn/2018/06/23/👏下载→Java程序员常读书单📚/java--readwritelock)
