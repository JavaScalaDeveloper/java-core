...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/基础加餐/instanceof-jvm-b676fee6-bfd4-4ae9-9c7b-e488e345f775.gif)
...
- 该编译器的抽象语法树节点有一个JCTree.JCInstanceOf类用于表示instanceof运算。做语法分析的时候解析到[instanceof运算符](https://tobebetterjavaer.com/基础加餐/instanceof.html)就会生成这个JCTree.JCInstanceof类型的节点。
