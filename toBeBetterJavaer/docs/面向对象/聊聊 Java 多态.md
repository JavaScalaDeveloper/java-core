...
“三妹啊，前面聊完了 Java 的[封装](https://tobebetterjavaer.com/面向对象/encapsulation.html)、[继承](https://tobebetterjavaer.com/面向对象/extends-bigsai.html)，今天我们来继续聊多态，也是 Java 三大特性的最后一个特性，搞懂它，Java 面向对象编程基本上就能轻松拿捏了。”我对三妹说。
