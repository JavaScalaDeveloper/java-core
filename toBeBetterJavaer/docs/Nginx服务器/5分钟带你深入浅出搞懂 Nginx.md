...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/5分钟带你深入浅出搞懂 Nginx/nginx-01.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/5分钟带你深入浅出搞懂 Nginx/nginx-02.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/5分钟带你深入浅出搞懂 Nginx/nginx-03.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/5分钟带你深入浅出搞懂 Nginx/nginx-04.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/5分钟带你深入浅出搞懂 Nginx/nginx-05.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/5分钟带你深入浅出搞懂 Nginx/nginx-06.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/5分钟带你深入浅出搞懂 Nginx/nginx-07.png)

第二步，通过 `brew install nginx` 命令安装 Nginx。


![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/5分钟带你深入浅出搞懂 Nginx/nginx-08.png)

从以上信息可以得出：

- 根目录是 `/usr/local/Java变量-了解局部变量、成员变量、静态变量和常量的特点与用途/www`
- 配置文件是 `/usr/local/etc/5分钟带你深入浅出搞懂 Nginx/nginx.conf`
- 默认端口是 8080

第三步，通过 `nginx` 命令启动 Nginx。


![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/5分钟带你深入浅出搞懂 Nginx/nginx-09.png)

第四步，在浏览器地址栏通过 `localhost:8080` 访问，可以看到以下欢迎页面。


![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/5分钟带你深入浅出搞懂 Nginx/nginx-10.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/5分钟带你深入浅出搞懂 Nginx/nginx-11.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/5分钟带你深入浅出搞懂 Nginx/nginx-12.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/5分钟带你深入浅出搞懂 Nginx/nginx-13.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/5分钟带你深入浅出搞懂 Nginx/nginx-14.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/5分钟带你深入浅出搞懂 Nginx/nginx-15.png)
