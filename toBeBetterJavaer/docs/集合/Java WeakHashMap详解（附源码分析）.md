...
head:
  - - meta
    - name: keywords
      content: Java,Java SE,Java基础,Java教程,Java程序员进阶之路,Java进阶之路,Java入门,教程,WeakHashMap
---


在Java中，我们一般都会使用到Map，比如[HashMap](https://tobebetterjavaer.com/集合/hashmap.html)这样的具体实现。更高级一点，我们可能会使用WeakHashMap。
