...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/5分钟带你深入浅出搞懂 Nginx/40-interview-63553177-7359-4f68-8673-5b44285cb701.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/5分钟带你深入浅出搞懂 Nginx/40-interview-8cd652f4-5a93-4e12-a020-0d90b9379bf2.png)
...
```
location /image/ {
    root   /usr/local/详解 Java static 关键字的作用-静态变量、静态方法、静态代码块、静态内部类/;
    autoindex on;
}
```
...
```
# 创建目录
mkdir /usr/local/详解 Java static 关键字的作用-静态变量、静态方法、静态代码块、静态内部类/image
 
# 进入目录
cd  /usr/local/详解 Java static 关键字的作用-静态变量、静态方法、静态代码块、静态内部类/image
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/5分钟带你深入浅出搞懂 Nginx/40-interview-8b8c7eeb-5542-43ab-9acc-3c7e51b5a4ac.png)
...
location ~ /media {
      alias /data/详解 Java static 关键字的作用-静态变量、静态方法、静态代码块、静态内部类/;
}
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/5分钟带你深入浅出搞懂 Nginx/40-interview-57f54ac6-82fe-403c-af37-728d707d5eca.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/5分钟带你深入浅出搞懂 Nginx/40-interview-4bebeaf2-3853-4bb3-a34d-10316a230854.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/5分钟带你深入浅出搞懂 Nginx/40-interview-fb46fd48-e596-48ac-8759-0663d29593af.png)


现在我们开启了gzip进行压缩后的文件的大小，可以看到如下所示：


![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/5分钟带你深入浅出搞懂 Nginx/40-interview-1ee18fd5-1cc1-478a-9fca-d15f85f0f5c7.png)


并且我们查看响应头会看到gzip这样的压缩，如下所示


![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/5分钟带你深入浅出搞懂 Nginx/40-interview-c3c95717-45ee-4f56-b606-d56d2fc3cc57.png)
