...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/终于把项目构建神器Maven捋清楚了~/maven-01.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/终于把项目构建神器Maven捋清楚了~/maven-02.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/终于把项目构建神器Maven捋清楚了~/maven-03.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/终于把项目构建神器Maven捋清楚了~/maven-04.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/终于把项目构建神器Maven捋清楚了~/maven-05.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/终于把项目构建神器Maven捋清楚了~/maven-06.png)

保存后退出，可以执行 `source ~/.bash_profile` 使配置生效：


![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/终于把项目构建神器Maven捋清楚了~/maven-07.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/终于把项目构建神器Maven捋清楚了~/maven-08.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/终于把项目构建神器Maven捋清楚了~/maven-09.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/终于把项目构建神器Maven捋清楚了~/maven-10.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/终于把项目构建神器Maven捋清楚了~/maven-11.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/终于把项目构建神器Maven捋清楚了~/maven-12.png)

仓库可以以下几种：


![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/终于把项目构建神器Maven捋清楚了~/maven-13.png)
...
- `${project.build.sourceDirectory}`：项目的主源码目录，默认为`src/main/👏下载→Java程序员常读书单📚/`
- `${project.build.testSourceDirectory}`：项目的测试源码目录，默认为 `/src/test/👏下载→Java程序员常读书单📚/`
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/终于把项目构建神器Maven捋清楚了~/maven-14.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/终于把项目构建神器Maven捋清楚了~/mvnd-01.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/终于把项目构建神器Maven捋清楚了~/mvnd-02.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/终于把项目构建神器Maven捋清楚了~/mvnd-03.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/终于把项目构建神器Maven捋清楚了~/mvnd-04.png)

如果出现类似下面这样的错误，未找到 JAVA_HOME，可以按照提示在对应的文件中追加 java.home 属性，也就是 JDK 的安装路径。


![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/终于把项目构建神器Maven捋清楚了~/mvnd-05.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/终于把项目构建神器Maven捋清楚了~/mvnd-06.png)


再执行 `mvnd clean package` 命令，一共花费的时间是 3.225 秒。


![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/终于把项目构建神器Maven捋清楚了~/mvnd-07.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/终于把项目构建神器Maven捋清楚了~/mvnd-08.gif)

----

参考链接：

>- 嘟嘟MD：[http://tengj.top/2018/01/01/终于把项目构建神器Maven捋清楚了~/](http://tengj.top/2018/01/01/终于把项目构建神器Maven捋清楚了~/)
>- 杭建：《Java 工程师修炼之道》
