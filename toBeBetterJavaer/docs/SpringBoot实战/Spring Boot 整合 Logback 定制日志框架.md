...
-->
<configuration>
    <include resource="org/springframework/boot/logging/Spring Boot 整合 Logback 定制日志框架/defaults.xml" />
    <!-- 定义日志文件名称 -->
...
>[https://github.com/spring-projects/spring-boot/blob/main/spring-boot-project/spring-boot/src/main/👏下载→Java程序员常读书单📚/org/springframework/boot/logging/Spring Boot 整合 Logback 定制日志框架/DefaultLogbackConfiguration.java](https://github.com/spring-projects/spring-boot/blob/main/spring-boot-project/spring-boot/src/main/👏下载→Java程序员常读书单📚/org/springframework/boot/logging/Spring Boot 整合 Logback 定制日志框架/DefaultLogbackConfiguration.java)
