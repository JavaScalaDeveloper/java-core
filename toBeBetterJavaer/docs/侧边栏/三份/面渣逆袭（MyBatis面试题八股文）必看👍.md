...
![MyBatis logo](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/mybatis-41c60cf7-6551-4720-8735-290a083640a5.png)
...
![ORM简单示意图](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/mybatis-ea212850-56e0-4d12-98fb-03bb40007f44.png)
...
![JDBC编程的不足](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/mybatis-f8b181a3-ad40-4381-98ba-351668579bfb.png)
...
![这还用说？](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/mybatis-4964e454-7c80-4768-bf0e-d0bf417353ef.gif)
...
![Mybatis vs Hibernate](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/mybatis-d1c707f7-0bd0-415c-b190-4757792c072b.png)
...
![Mybatis基本使用步骤](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/mybatis-47bab2e8-5c08-4f61-9c0c-dddfe09fb2b5.png)
...
````java
String resource = "org/Spring Boot 整合 MyBatis/example/mybatis-config.xml";
...
![MyBatis主要组件生命周期](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/mybatis-79f75371-14c9-4ac9-9d3b-5d80b22705a1.png)
...
![这个应该会](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/mybatis-2c55dfeb-bea1-466f-9b1e-d8c001856aa5.png)

### 4. 在mapper中如何传递多个参数？


![mapper传递多个参数方法](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/mybatis-dd039a20-ae4f-4f6a-b497-01937073198b.png)
...
![`#{}和${}比较`](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/mybatis-8d2d5dc1-8f92-456d-b858-7d3a7888f2eb.png)
...
![concat拼接like](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/mybatis-e5dde8ba-7808-410b-986a-2fc15ba55e21.png)
...
![MyBatis级联](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/mybatis-aa1e0cc1-1a5f-4efe-9aed-3081b15c9a2a.png)
...
![MyBatis](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/mybatis-f52c027d-25a5-4bd9-b5d3-1421655546a5.png)
...
![MyBatis批量操作](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/mybatis-24225f07-fbe6-40c8-a63b-a94983f9107a.png)
...
![Mybatis一级缓存](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/mybatis-54afb458-7dfc-4d48-9a90-4ad1a8739937.png)
...
![Mybatis二级缓存示意图](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/mybatis-8dae71da-ffd4-43f5-9ee9-258ea82d216b.png)
...
![MyBatis的工作流程](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/mybatis-61ac17ef-9eee-48c0-9a2d-545e1d554b13.png)
...
![构建会话工厂](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/mybatis-234a4d1b-2d44-4576-9954-26f56162750e.png)
...
![MyBatis会话运行四大关键组件](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/mybatis-da477d50-209e-45b3-a003-6d63e674bd99.png)
...
![会话运行的简单示意图](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/mybatis-ebd0712a-1f62-4154-b391-2cb596634710.png)


> 我们最后把整个的工作流程串联起来，简单总结一下：


![MyBatis整体工作原理图](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/mybatis-dc142e94-8e7f-4ec6-a1f6-1d20669292ad.png)
...
![MyBatis功能架构](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/mybatis-c7b59a67-49f4-48f8-a25d-033daeea7e3e.png)
...
![Mapper代理](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/mybatis-15e30a15-f34c-4aa4-b131-4ddc8620348e.png)
...
![Mybatis Executor类型](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/mybatis-59340143-5155-4719-869e-304b5738b2f2.png)
...
![MyBatis插件原理简图](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/mybatis-00f2581b-5aae-441a-83f7-75641b3ba010.png)

Mybatis使用JDK的动态代理，为目标对象生成代理对象。它提供了一个工具类`Plugin`，实现了`InvocationHandler`接口。


![Plugin中调用插件方法](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/mybatis-c487f77a-9b87-4d9b-9a49-5aa87401b5e8.png)
...
![Mybatis-通用分页拦截器](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/mybatis-0bcdca85-e127-44ff-92e0-368a3f089ec8.png)
