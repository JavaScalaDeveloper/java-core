...
![Java集合主要关系](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/collection-1.png)
...
![ArrayList和LinkedList的数据结构](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/collection-2.png)
...
![ArrayList和LinkedList中间插入](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/collection-3.png)


![ArrayList和LinkedList中间删除](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/collection-4.png)
...
![ArrayList扩容](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/collection-5.png)
...
![ArrayList自定义序列化](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/collection-6.png)
...
![CopyOnWriteArrayList原理](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/collection-7.png)
...
![jdk1.8 hashmap数据结构示意图](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/collection-8.png)
...
![红黑树](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/collection-9.png)
...
![左旋](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/collection-10.png)


![右旋](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/collection-11.png)

- 染⾊：


![染色](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/collection-12.png)
...
![HashMap插入数据流程图](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/collection-13.jpg)
...
![HashMap查找流程图](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/collection-14.png)
...
![哈希&运算](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/collection-15.png)
...
![扰动函数示意图](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/collection-16.jpg)
...
![put中的扩容](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/collection-17.png)
...
![容量计算](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/collection-18.png)
...
![散列函数构造](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/collection-19.png)
...
![开放定址法](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/collection-20.png)
...
![源码注释](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/collection-21.png)
...
![put时，扩容](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/collection-22.png)
...
![threshold计算](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/collection-23.png)
...
![关于默认负载因子的注释](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/collection-24.png)
...
![扩容之后的索引计算](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/collection-25.png)

元素在重新计算hash之后，因为n变为2倍，那么n-1的mask范围在高位多1bit(红色)，因此新的index就会发生这样的变化：


![扩容位置变化](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/collection-26.png)

所以在扩容时，只需要看原来的hash值新增的那一位是0还是1就行了，是0的话索引没变，是1的化变成`原索引+oldCap`，看看如16扩容为32的示意图：


![扩容节点迁移示意图](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/collection-27.png)

扩容节点迁移主要逻辑：


![扩容主要逻辑](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/collection-28.png)
...
![自定义HashMap整体结构](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/collection-29.png)

完整代码：


![完整代码](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/collection-30.png)
...
![1.7ConcurrentHashMap示意图](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/collection-31.png)
...
<img src="https://gitee.com/三份/picgo3/raw/master/20211128230624.jpg" alt="jdk1.7 put流程" style="zoom: 50%;" />
...
![ConcurrentHashmap jdk1.8put流程](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/collection-32.jpg)
...
![Entry节点](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/collection-33.png)

可以实现按插入的顺序或访问顺序排序。


![LinkedHashMap实现原理](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/collection-34.png)
...
![TreeMap](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/collection-35.png)
...
![HashSet套娃](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/collection-36.png)
