...
![操作系统是什么](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/os-be55aec1-e7ab-433f-97f1-14d99960b6bf.png)
...
![操作系统主要功能](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/os-eee82952-c96f-45c9-835e-29db37c0f6d8.png)
...
![用户态&内核态切换](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/os-b358cdae-18b6-45d4-8a5b-4ea3a7cfc273.png)
...
![并发和并行](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/os-fb7891d8-8330-494b-9bc1-cf829b5cc82d.png)
...
![进程上下文切换-来源参考[3]](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/os-187d1cf9-971d-4395-b888-5e6eaf2be5f1.png)
...
![进程3种状态](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/os-5df30631-ad7d-4c65-af20-50b7b615eca8.png)
...
![进程5种状态](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/os-ae17a9dc-f555-481a-ba4a-caca06120be7.png)
...
![进程调度算法](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/os-18911b0a-7326-467f-94fb-8c01a6980578.png)
...
![先来先服务](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/os-93088d03-80c9-46c5-9eaf-eead2adb6e12.png)
...
![短作业优先](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/os-517e8392-64fe-4de3-9e1c-b3a944822aba.png)
...
![优先级调度](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/os-7c4441cf-7b8c-4660-8ba8-29b8076e2da1.png)
...
![时间片轮转](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/os-ad224c3a-8ac9-4230-84e4-ec434d5b49f9.png)
...
![进程间通信方式](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/os-34b8635f-ec27-46c6-87c3-91440fea662d.png)
...
![“奉先我儿”](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/os-5994e202-0d59-4a86-8f79-a17a5d0bd3d3.png)
...
![消息队列](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/os-d3d8bef5-ae32-487f-828d-aaddb93867c4.png)
...
![共享内存](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/os-d9e3cfaf-01e7-42ff-9290-94ef4a5c7d5e.png)
...
![信号量](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/os-5fb765af-918c-4037-a3ad-4cad4d985e16.png)
...
![多线程-来源参考[3]](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/os-271e450b-66ef-4f6c-b823-8e0b73347825.png)
...
![内核态线程实现](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/os-30b84285-8027-4720-b50b-3b0fb18c756f.png)

- **⽤户态线程实现**：在⽤户空间实现线程，不需要内核的参与，内核对线程无感知。


![用户态线程](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/os-57886181-56fe-42bf-85e1-4d062455788a.png)
...
![混合线程实现](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/os-1597d159-1b07-48ae-ac86-7e9b9cb85876.png)
...
![临界区互斥-来源参考[3]](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/os-48a5b48b-2474-4460-ac5b-9502883b353f.png)
...
![加锁和解锁-来源参考[3]](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/os-4bd37c12-992d-4660-8b63-15c3b35d105f.png)
...
![死锁](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/os-e0069c37-d758-4df0-a2fd-3722ec93c61a.png)
...
![虚拟内存](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/os-ec171cea-0046-4709-a390-7babf3272c49.png)
...
![虚拟地址、段表、物理地址](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/os-075df152-7b77-40c7-abdb-1aa0280d958b.png)

我们来看一个映射，虚拟地址：段3、段偏移量500  ---->  段基地址7000+段偏移量500 ----> 物理地址：7600+。


![段虚拟地址映射](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/os-a57baf1c-9612-49dd-8b23-8b00a0c63cef.png)
...
![内存分页](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/os-4cdd5179-4b88-4aa6-b9c2-9ef8fdc745dc.png)
...
![多级页表示意图](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/os-3021f22f-b9a3-49d9-9e80-6d3abaf5a61a.png)
...
![TLB示意图-来源参考[3]](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/os-cdc02a2f-59bf-45dc-8531-83b46f77bd65.png)
...
![常见页面置换算法](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/os-6effefb6-67d2-4155-a3fc-4b27a319391a.png)
...
![按照进入内存早晚构建的页面链表 ](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/os-8cccc78d-ba25-4c0a-8ee8-0913e80af7b7.png)
...
![LRU实现](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/os-90810f7f-aa5b-4626-9761-c2c622b5e561.png)
...
![时钟页面置换算法](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/os-3646408f-999e-48a1-84e9-113525778aca.png)
...
![硬链接-来源参考[3]](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/os-d3f778f9-506b-4b93-9fb7-40eb0a79874e.png)
...
![软链接-来源参考[3]](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/os-81abf13c-5c60-4263-8fcb-c79c33d865e8.png)
...
![传统文件传输示意图-来源参考[3]](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/os-1e595664-6585-4d56-8939-08b7ce510218.png)
...
![mmap示意图-来源参考[3]](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/os-6dc49f9d-0bc3-4956-a650-7c7236f234a2.png)
...
![sendfile示意图-来源参考[3]](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/os-0b087b8a-8d51-4aad-898d-d99c38d36592.png)
...
![阻塞I/O](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/os-f06db5ff-661c-4ddf-9115-4ed9c9a21d01.png)
...
![非阻塞I/O](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/os-771e014e-7ed9-4101-8bb5-4413b8069fd6.png)
...
![基于非阻塞的I/O多路复用](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/os-86e54fa3-ad36-43c7-9d2d-5a68139c310f.png)
...
![异步/IO](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/os-869021ed-5e4e-4490-9174-7291d8ddf55c.png)
...
![鸽宗](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/os-54c60eb2-2a1c-4268-88b5-6b462e00144c.png)
...
![I/O多路复用](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/os-9b276b14-eb1b-47bf-b2aa-25212e1bbdf8.png)
...
![epoll接口作用-来源参考[3]](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/os-cca76ac4-cfb4-4374-8fc6-256cd4d3893f.png)
