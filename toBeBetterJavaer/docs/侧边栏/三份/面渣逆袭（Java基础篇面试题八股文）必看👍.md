...
![下辈子还学Java](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javase-1.png)
...
![Java语言特点](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javase-2.png)
...
![JDK、JRE、JVM关系](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javase-3.png)
...
![Java程序执行过程](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javase-4.png)
...
![编译与解释](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javase-5.png)
...
![Java数据类型](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javase-6.png)
...
![Java自动类型转换方向](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javase-7.png)
...
![装箱和拆箱](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javase-8.png)
...
![break 、continue 、return](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javase-9.png)
...
![面向对象和面向过程的区别](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javase-10.png)

### 16.面向对象有哪些特性


![面向对象三大特征](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javase-11.png)
...
![访问修饰符和可见性](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javase-12.png)
...
![final修饰变量](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javase-13.png)
...
![Java引用数据值传递示意图](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javase-14.png)
...
![浅拷贝和深拷贝示意图](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javase-15.png)
...
![Java创建对象的四种方式](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javase-16.png)
...
![堆与常量池中的String](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javase-17.png)
...
![jdk1.8之前的字符串拼接](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javase-18.png)
...
![Integer.valueOf](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javase-19.png)
...
![parseInt示意图](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javase-20.png)
...
![Object类的方法](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javase-21.png)
...
![Java异常体系](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javase-22.png)
...
![异常处理](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javase-23.png)
...
![IO-操作方式分类-图片来源参考[2]](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javase-24.jpeg)
...
![Java IO流用到装饰器模式](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javase-25.png)
...
![BIO、NIO、AIO](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javase-26.png)
...
![BIO、NIO、AIO](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javase-27.png)
...
![NIO线程](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javase-28.png)
...
![NIO完整示意图](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javase-29.png)
...
![序列化和反序列化](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javase-30.png)
...
![Java常见序列化方式](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javase-31.png)
...
![泛型类、泛型接口、泛型方法](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javase-32.png)
...
![Java注解和帽子](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javase-33.png)
...
![Override注解](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javase-34.png)
...
![Autowired注解](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javase-35.png)
...
![Java反射相关类](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javase-36.png)
...
![JDK1.8主要新特性](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javase-37.png)
...
![Java Stream流](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javase-38.png)
