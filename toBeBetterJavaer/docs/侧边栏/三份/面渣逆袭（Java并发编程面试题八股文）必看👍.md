...
![并行和并发](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-1.png)

就好像我们去食堂打饭，并行就是我们在多个窗口排队，几个阿姨同时打菜；并发就是我们挤在一个窗口，阿姨给这个打一勺，又手忙脚乱地给那个打一勺。


![并行并发和食堂打饭](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-2.png)
...
![程序进程线程关系](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-3.png)
...
![线程创建三种方式](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-4.png)
...
![start方法](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-5.png)
...
![线程常用调度方法](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-6.png)
...
![Java线程状态变化](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-7.png)
...
![线程切换-2020-12-16-2107](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-8.png)

为了让用户感觉多个线程是在同时执行的， CPU 资源的分配采用了时间片轮转也就是给每个线程分配一个时间片，线程在时间片内占用 CPU 执行任务。当线程使用完时间片后，就会处于就绪状态并让出 CPU 让其他线程占用，这就是上下文切换。


![上下文切换时机](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-9.png)
...
![线程间通信方式](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-10.png)
...
![ThreadLocal线程副本](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-11.png)
...
![ThreadLoca存放用户上下文](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-12.png)
...
![ThreadLoca结构图](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-13.png)
...
![ThreadLocal内存分配](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-14.png)
...
![ThreadLocalMap结构示意图](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-15.png)
...
![ThreadLocalMap解决冲突](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-16.png)
...
![ThreadLocalMap扩容](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-17.png)
...
![ThreadLocalMap resize](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-18.png)
...
![Java内存模型](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-19.png)

本地内存是JMM的 一个抽象概念，并不真实存在。它其实涵盖了缓存、写缓冲区、寄存器以及其他的硬件和编译器优化。


![实际线程工作模型](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-20.png)
...
![多级指令重排](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-21.png)
...
![双重校验单例模式异常情形](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-22.png)
...
![happens-before六大规则](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-23.png)
...
![](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-24.png)
...
![两种执行结果](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-25.png)
...
![volatile内存可见性](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-26.png)
...
![volatile重排序规则表](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-27.png)
...
![volatile写插入内存屏障后生成的指令序列示意图](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-28.png)


![volatile写插入内存屏障后生成的指令序列示意图](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-29.png)
...
![monitorenter和monitorexit](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-30.png)
...
![synchronized修饰同步方法](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-31.png)
...
![就诊-图片来源参考[18]](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-32.png)
...
![Java Montior机制](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-33.png)
...
![Mark Word变化](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-34.png)
...
![锁升级方向](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-35.png)
...
![锁升级简略过程](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-36.png)

完整的升级过程：


![synchronized 锁升级过程-来源参考[14]](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-37.png)
...
![synchronized和ReentrantLock的区别](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-38.png)
...
![AQS抽象队列同步器](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-39.png)


![CLH队列](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-40.png)

AQS 中的队列是 CLH 变体的虚拟双向队列，通过将每条请求共享资源的线程封装成一个节点来实现锁的分配：


![AQS变种CLH队列](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-41.png)
...
![ReentrantLock 非公平锁加锁流程简图](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-42.png)
...
![公平锁tryAcquire](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-43.png)
...
![CAS三大问题](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-44.png)
...
![Java保证原子性方法](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-45.png)
...
![原子操作类](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-46.png)
...
![死锁示意图](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-47.png)

那么为什么会产生死锁呢？ 死锁的产生必须具备以下四个条件：


![死锁产生必备四条件](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-48.png)
...
![线程死锁检测](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-49.png)
...
![王者荣耀等待玩家确认-来源参考[18]](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-50.jpeg)
...
![王者荣耀-来源参考[18]](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-51.jpeg)
...
![想结衣结衣不依,迷爱理爱理不理。](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-52.png)

我们拿代码模拟这一场景，发现CountDownLatch无能为力了，因为CountDownLatch的使用是一次性的，无法重复利用，而这里等待了两次。此时，我们用CyclicBarrier就可以实现，因为它可以重复利用。


![小约翰可汗选妃模拟代码](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-53.png)

运行结果：


![运行结果](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-54.png)
...
![CyclicBarrier工作流程](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-55.png)
...
![停车场空闲车位提示-图片来源网络](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-56.jpeg)

我们把这个例子类比一下，车辆就是线程，进入停车场就是线程在执行，离开停车场就是线程执行完毕，看见红灯就表示线程被阻塞，不能执行，Semaphore的本质就是**协调多个线程对共享资源的获取**。 


![Semaphore许可获取-来源参考[18]](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-57.jpeg)
...
![英雄交换猎物-来源参考[18]](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-58.jpeg)
...
![管理线程的池子](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-59.png)
...
![业务示例](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-60.png)

主要代码如下：


![主要代码](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-61.png)
...
![直接办理](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-62.png)

2. 老三发现没有空闲的窗口，就在排队区排队等。


![排队等待](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-63.png)
...
![排队区满](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-64.png)

4. 老三一看，六个窗口都满了，等待区也没位置了。老三急了，要闹，经理赶紧出来了，经理该怎么办呢？


![等待区，排队区都满](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-65.png)
...
![线程池执行流程](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-66.png)
...
![线程池参数](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-67.png)
...
![四种策略](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-68.png)
...
![线程池常用阻塞队列](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-69.png)
...
![常见线程池参数配置方案-来源美团技术博客](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-70.png)
...
![四大线程池](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-71.png)
...
![SingleThreadExecutor运行流程](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-72.png)
...
![FixedThreadPool](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-73.png)
...
![CachedThreadPool执行流程](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-74.png)
...
![ScheduledThreadPool执行流程](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-75.png)
...
![ScheduledThreadPoolExecutor执行流程](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-76.png)
...
![线程池异常处理](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-77.png)
...
![线程池状态切换图](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-78.png)
...
![JDK 线程池参数设置接口来源参考[7]](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-79.png)

这里主要有两个思路：

![动态修改线程池参数](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-80.png)
...
![线程池评估方案 来源参考[7]](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-81.png)
...
![线程池调优](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-82.png)
...
![线程池主要实现流程](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-83.png)
...
![自定义线程池](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-84.png)
...
![Fork/Join分治算法](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-85.png)
...
![工作窃取](https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/侧边栏/三份/javathread-86.png)
